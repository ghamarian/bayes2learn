...
var grammar = {
    ...
    {"name": "simple_stmt", "symbols": ["expr_stmt", "_", "simple_stmt$ebnf$1", "_", "simple_stmt$ebnf$2"], "postprocess": id},
    ...
    {"name": "test", "symbols": ["or_test", "_", "test$ebnf$1"], "postprocess": id},
    ...
    {"name": "or_test", "symbols": ["and_test", "_", "or_test$ebnf$1"], "postprocess": id},
    ...
    {"name": "and_test", "symbols": ["not_test", "_", "and_test$ebnf$1"], "postprocess": id},
    {"name": "not_test$string$1", "symbols": [{"literal":"n"}, {"literal":"o"}, {"literal":"t"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "not_test", "symbols": ["not_test$string$1", "_", "not_test"]},
    ...
    {"name": "comparison", "symbols": ["expr", "_", "comparison$ebnf$1"], "postprocess": id},
    ...
    {"name": "comp_op", "symbols": ["comp_op$string$10", "comp_op$string$11"], "postprocess": id},
    {"name": "star_expr", "symbols": [{"literal":"*"}, "_", "expr"], "postprocess": id},
    ...
    {"name": "atom_expr", "symbols": ["atom_expr$ebnf$1", "_", "atom", "_", "atom_expr$ebnf$2"], "postprocess": id},
    ...
    {"name": "subscript", "symbols": ["subscript$ebnf$1", "_", {"literal":":"}, "_", "subscript$ebnf$2", "_", "subscript$ebnf$3"], "postprocess": id},
    {"name": "sliceop$ebnf$1", "symbols": ["test"], "postprocess": id},
    {"name": "sliceop$ebnf$1", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "sliceop", "symbols": [{"literal":":"}, "_", "sliceop$ebnf$1"], "postprocess": id},
    ...
    {"name": "argument$subexpression$1", "symbols": ["test", "_", "argument$subexpression$1$ebnf$1"]},
    {"name": "argument$subexpression$1", "symbols": ["test", "_", {"literal":"="}, "_", "test"]},
    {"name": "argument$subexpression$1$string$1", "symbols": [{"literal":"*"}, {"literal":"*"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "argument$subexpression$1", "symbols": ["argument$subexpression$1$string$1", "_", "test"]},
    {"name": "argument$subexpression$1", "symbols": [{"literal":"*"}, "_", "test"]},
    ...
    {"name": "sync_comp_for", "symbols": ["sync_comp_for$string$1", "_", "exprlist", "_", "sync_comp_for$string$2", "_", "or_test", "_", "sync_comp_for$ebnf$1"], "postprocess": id},
    ...
    {"name": "comp_for", "symbols": ["comp_for$ebnf$1", "_", "sync_comp_for"], "postprocess": id},
    ...
    {"name": "comp_if", "symbols": ["comp_if$string$1", "_", "test_nocond", "_", "comp_if$ebnf$1"], "postprocess": id},
    ...
    {"name": "number", "symbols": ["number$ebnf$1", "number$ebnf$2", "number$ebnf$3"], "postprocess": id},
    ...
    {"name": "name", "symbols": ["name$ebnf$1"], "postprocess": id},
    {"name": "dqstring$ebnf$1", "symbols": []},
    {"name": "dqstring$ebnf$1", "symbols": ["dqstring$ebnf$1", "dstrchar"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "dqstring", "symbols": [{"literal":"\""}, "dqstring$ebnf$1", {"literal":"\""}], "postprocess": id},
