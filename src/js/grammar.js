...
var grammar = {
    ...
    {"name": "atom_expr", "symbols": ["atom_expr$ebnf$1", "_", "atom", "_", "atom_expr$ebnf$2"], "postprocess": d => {console.log(`amir`); console.dir(d); return d}},
    ...
    {"name": "number", "symbols": ["number$ebnf$1", "number$ebnf$2", "number$ebnf$3"], "postprocess": d =>  d[1].join("")},
    ...
    {"name": "dqstring", "symbols": [{"literal":"\""}, "dqstring$ebnf$1", {"literal":"\""}], "postprocess": d => d.join("")},
