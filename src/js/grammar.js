...
var grammar = {
    ...
    {"name": "test", "symbols": ["or_test", "_", "test$ebnf$1"], "postprocess": d => {console.log(`inja ${d}`); return d;}},
    ...
    {"name": "atom_expr", "symbols": ["atom_expr$ebnf$1", "_", "atom", "_", "atom_expr$ebnf$2"], "postprocess": d => {console.log(`amir - ${d}`); return d}},
    ...
    {"name": "argument$subexpression$1", "symbols": ["test", "_", "argument$subexpression$1$ebnf$1"], "postprocess": id},
    ...
    {"name": "number", "symbols": ["number$ebnf$1", "number$ebnf$2", "number$ebnf$3"], "postprocess": d => { var k = d.join(); console.log(`something ${k}`); return d.join() }},
    ...
    {"name": "name", "symbols": ["name$ebnf$1"], "postprocess": d => { var k = d.join(); console.log(`something ${k}`); return d.join() }},
    {"name": "dqstring$ebnf$1", "symbols": []},
    {"name": "dqstring$ebnf$1", "symbols": ["dqstring$ebnf$1", "dstrchar"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "dqstring", "symbols": [{"literal":"\""}, "dqstring$ebnf$1", {"literal":"\""}], "postprocess": d => { var k = d.join(); console.log(`something ${k}`); return d.join() }},
    {"name": "dstrchar", "symbols": [/[^\\"\n]/], "postprocess": id},
    {"name": "string", "symbols": ["dqstring"], "postprocess": d => { console.log(`kashk ${d}`); return d.join();}},
